...
def authenticate_gdoc(service_account_file: str, scopes: list):
    """Authenticate with Google Docs API and return the docs() service."""
    credentials = service_account.Credentials.from_service_account_file(
        service_account_file, scopes=scopes)
...
def main():
    ...
    doc = authenticate_gdoc(SERVICE_ACCOUNT_FILE, SCOPES)
